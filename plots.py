"""Plot metadata statistics for datasets/*.json using plotext.

Usage:
    python3 plots.py                    # show all plots
    python3 plots.py --plot access      # one plot
    python3 plots.py --plot access --plot form
    python3 plots.py --table            # show all stats as tables
    python3 plots.py --plot access --both
